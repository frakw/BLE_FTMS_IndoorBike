...
extern "C" {
	...
	__declspec(dllexport) bool SubscribeCharacteristic_Read(wchar_t* deviceId, wchar_t* serviceId, wchar_t* characteristicId, bool block);
	
	__declspec(dllexport) bool SubscribeCharacteristic_Write(wchar_t* deviceId, wchar_t* serviceId, wchar_t* characteristicId, bool block);
